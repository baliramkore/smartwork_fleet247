...
public class InvoiceDetails {
    ...
    @SerializedName("agent_wallet_balance")
    @Expose
    public String agenWalletBalance;

    public String getAgenWalletBalance() {
        return agenWalletBalance;
    }

    public void setAgenWalletBalance(String agenWalletBalance) {
        this.agenWalletBalance = agenWalletBalance;
    }
