...
public class UpcomingBookingAdapter extends RecyclerView.Adapter<UpcomingBookingAdapter.ViewHolder> {
    ...
    public UpcomingBookingAdapter(RecyclerViewEventListener recyclerViewEventListener,List<Booking> bookingList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.upcoming_booking_list,parent,false);
        locale=Locale.getDefault();
        return new UpcomingBookingAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.paymentType.setText(bookingList.get(position).getPaymentType());
        ...
        switch (bookingList.get(position).getPassengers().size()){
            case 1:
                ...
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                break;
            case 2:
                holder.passengerName1.setText(passengers.get(0).peopleName);
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                holder.passengerName2.setText(passengers.get(1).peopleName);
                holder.passengerContact2.setText("+91"+passengers.get(1).peopleContact);
                break;
            case 3:
                holder.passengerName1.setText(passengers.get(0).peopleName);
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                ...
                holder.passengerContact3.setText("+91"+passengers.get(2).peopleContact);
                break;
            case 4:
                holder.passengerName1.setText(passengers.get(0).peopleName);
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                ...
                holder.passengerContact4.setText("+91"+passengers.get(3).peopleContact);
                break;
            case 5:
                holder.passengerName1.setText(passengers.get(0).peopleName);
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                ...
                holder.passengerContact5.setText("+91"+passengers.get(4).peopleContact);
                break;
            case 6:
                holder.passengerName1.setText(passengers.get(0).peopleName);
                holder.passengerContact1.setText("+91"+passengers.get(0).peopleContact);
                ...
                holder.passengerContact6.setText("+91"+passengers.get(5).peopleContact);
                break;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(final View itemView) {
            ...
            dropLocationLay=itemView.findViewById(R.id.upcoming_drop_location_lay);
            ...
            startBooking =itemView.findViewById(R.id.start_booking);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()){
                case R.id.passenger_details:
                    ...
                    break;
                case R.id.cancel_trip_floating_button:
                    recyclerViewEventListener.onCancelledClicked(bookingList.get(pos));
                    break;

                case R.id.start_booking:
    ...
    public interface RecyclerViewEventListener{
        ...
        void onCancelledClicked(Booking booking);
    }
}
