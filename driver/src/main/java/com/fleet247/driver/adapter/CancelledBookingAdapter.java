...
import com.fleet247.driver.data.models.cancelledbookings.Passenger;
...
public class CancelledBookingAdapter extends RecyclerView.Adapter<CancelledBookingAdapter.ViewHolder> {
    ...
    public CancelledBookingAdapter(CancelledBookingAdapter.RecyclerViewEventListener recyclerViewEventListener, List<Booking> bookingList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cancelled_booking_lay,parent,false);
        return new CancelledBookingAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cancellationReason.setText(bookingList.get(position).getCancelReason());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View itemView) {
            ...
            dropLocationLay=itemView.findViewById(R.id.cancelled_drop_location_lay);
